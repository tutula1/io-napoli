      ...
      buttons: [
        ...
        },
        {
          ...
          handler: () => {
            ...
            this.productCategoryService.updateProductCategory(item.payload.doc.id, data).then(
              (res) => {
    ...
    const alert = await this.alertCtrl.create({
      ...
      buttons: [
        ...
        },
        {
          text: "Xoá",
          handler: () => {
            this.productCategoryService.deleteProductCategory(item.payload.doc.id).then(
              (res) => {
                this.utilsService.presentToast("Thành công!", 2000);
              },
              (err) => console.log(err),
